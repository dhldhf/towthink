...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '$Up^%23ZR)blkNW;t:8zLo.`a04/g}E|(,x~Qm_A', //默认数据加密KEY
	'data_cache_key'=> '$Up^%23ZR)blkNW;t:8zLo.`a04/g}E|(,x~Qm_A',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'$Up^%23ZR)blkNW;t:8zLo.`a04/g}E|(,x~Qm_A', //加密KEY
