<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\www\twothink\public/../application/admin/view/default/ticket\index.html";i:1526197619;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tbody>
        <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ticket): $mod = ($i % 2 );++$i;?>
        <tr>
            <td><input class="ids row-selected" type="checkbox" name="" id="" value="<?php echo $ticket['id']; ?>"> </td>
            <td><?php echo $ticket['id']; ?></td>
            <td><?php echo $ticket['title']; ?></td>
            <td><?php echo $ticket['name']; ?></td>
            <td><?php echo $ticket['tel']; ?></td>
            <td><?php echo $ticket['address']; ?></td>
            <td><?php echo date("Y-m-d H:i:s",$ticket['create_time']); ?></td>
            <td><?php echo $ticket['content']; ?></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$ticket['id'].'&pid='.$pid); ?>">编辑</a>
                <a class="confirm ajax-get" title="删除" href="<?php echo url('del?id='.$ticket['id']); ?>">删除</a>
            </td>
        </tr>
